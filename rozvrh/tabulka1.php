...
?>
	...
	<a href="http://localhost/projekt1/rozvrh/tabulka1.php?jazyk=sk">SK</a>
	<a href="http://localhost/projekt1/rozvrh/tabulka1.php?jazyk=en">EN</a>
...
$result1= mysqli_query($conn,$sql1);
	...
	{
		echo "<a href=tabulka1.php?trieda=".$row1["trieda"]."&amp;skupina=".$row1["skupina"].">".$row1["trieda"]." - ".$row1["skupina"].".sk</a></br>";
	}
